...
<div id="wrap">	
	...
	<div id="mainFrame">
		...
		<div id="frmBackground">
			...
			<span id="currentBottomMenuName"> > 공지사항 작성</span>
		</div>
		<!-- 최상단 메뉴이름 타이틀바 끝 -->
		
		<!-- 내용 시작 -->
		<div id="contentWrap" style="margin-left:100px; width: 700px; height: 749px;">
			<form method="post" action="mgt_announce_write_process.jsp" name="frmWrite" id="frmWrite">
				...
				<div style="margin:0px auto;" >
					<table>
						<tr style="border:none;">
							...
							<td style="border:none;"><input type="text" name="title" id="title" style="width: 600px; height: 40px;" /></td>
						</tr>
						<tr  style="border:none;">
							<td style="border:none;">조회수</td>
							<td style="border:none;"><input type="text" name="views" id="views" value="0"
				...
				<div style="margin-top:20px; float:right;">
					<input type="button" value="글 작성" class="btn btn-sm btn-primary btn-lg" id="btnWrite" />
