...
<!-- 파라미터 받기 -->
<jsp:useBean id="rarrVO" class="prj2.mgt.post.vo.RestAreaReviewRepVO" scope="page"></jsp:useBean>
<jsp:setProperty property="*" name="rarrVO"/>
...
<script type="text/javascript">
	...
	try {
		...
		int cnt = mrrDAO.updateRevRep(rarrVO, managerId);
		if (cnt > 1) {
 		%>
			alert('신고 처리 내역이 업데이트 되었습니다');
			location.href = "mgt_report_review_detail_frm.jsp?rnum=${param.rnum}&num=${param.num}&currentPage=${param.currentPage}&reportMemId=${param.reportMemId}&update=1";
		<%
		} // end if
